...
namespace Buttonica.Core.Framework.Rendering2D
{
	...
	public class Entity2D : EntityBase
	{
		...
		public Vector2 Position
		{
			...
			set
			{
				DrawArea = new RectangleF(value.X, value.Y, _drawArea.Width, _drawArea.Height);
			}
		}
		...
		public Vector2 TopLeft
		{
			...
			set {
				DrawArea = new RectangleF(value, DrawArea.Size);
			}
		}
		...
		public Vector2 Center
		{
			...
			set {
				DrawArea = RectangleF.FromCenter(value, DrawArea.Width, DrawArea.Height);
			}
		}
		...
		public Vector2 Size
		{
			...
			set {
				DrawArea = RectangleF.FromCenter(DrawArea.Center, value.X, value.Y);
			}
		}
