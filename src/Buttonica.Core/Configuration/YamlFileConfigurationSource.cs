...
namespace Buttonica.Core.Configuration
{
		...
		where TConfiguration : class, new()
	{
		...
		// YAML stuff
		private readonly Serializer		_serializer		= new Serializer(SerializationOptions.EmitDefaults, new HyphenatedNamingConvention());
		private readonly Deserializer	_deserializer	= new Deserializer(new DefaultObjectFactory(), new HyphenatedNamingConvention(), true);
		...
		/// <summary>
		///		Creates a new <see cref="YamlFileConfigurationSource{TConfiguration}"/> specifying the path to the configuration file
